                ...
                <div class="col-md-4 col-lg-4 mb-4 tab-content" data-content="{{ $field->category->name }}">
                    <div class="donation-row h-100">
                        <div class="donation-card">
                            <img src="{{ asset('storage/' . $field->cover_image) }}" class="card-img-top" alt="{{ $field->name }}">
...
<div class="stats-section container particles-js" id="particles-js" style="margin-top: -20px;">
    <div class="background-image"></div>
    <h2 style="color: #fff;">رواسخ في ارقام</h2>
    <div class="stats-content row p-3 " style="height: max-content" >
        <div class="stat-item col-lg-4 col-12 ">
...
<div class="partners-logos" style="margin-bottom:100px; text-align:center;">
    ...
    <img src="{{ asset('storage/' . $partner->logo) }}" alt="{{ $partner->name }}" style="max-width: 150px;">
    @endforeach
</div>
