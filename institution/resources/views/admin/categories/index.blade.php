        ...
        <table id="books-table" class="table table-striped table-bordered text-right" width="100%" cellspacing="0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><img src="{{ asset('/images' . $category->cover_image) }}" alt="صورة التصنيف" width="100"></td>

                    <td>
                        <a class="btn btn-info btn-sm" href="{{ route('categories.edit', $category->id) }}"><i class="fa fa-edit"></i> تعديل</a>
