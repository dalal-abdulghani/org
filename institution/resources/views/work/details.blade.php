                ...
                <div class="col-lg-8">
                    ...
                    <div class="post post-single">
                        ...
                        <div class="featured-image">
                            <img src="{{ asset('storage/' . $work->cover_image) }}" alt="project-title" width="700px" />
                        </div>
                        <!-- post content -->
                        <div class="post-content clearfix">
                            <p class="project-content" style="width: 700px; text-align: justify;">{{ $work->description }}</p>
                        </div>
                        ...
                        <div class="post-bottom">
                            <div class="row d-flex align-items-center">
                                ...
                                <div class="col-md-6 col-12">
                                    <!-- social icons -->
                                    <ul class="social-icons list-unstyled list-inline mb-0 float-md-end" style="margin-left: 10px">
                                    ...
                                    <div class="post post-list-sm circle">
                                        <div class="thumb circle">
                                            ...
                                            <a href="{{ route('work_fields.show', $item->id) }}">
                                                <div class="inner">
                                                    <img src="{{ asset('storage/' . $item->cover_image) }}" alt="{{ $item->name }}" width="50px" height="50px" style="border-radius: 50%" />
                                                </div>
                                            </a>
                                        </div>
                                        <div class="details clearfix">
                                            <h6 class="post-title my-0">
                                                <a href="{{ route('work_fields.show', $item->id) }}">{{ Str::limit($item->name, 20) }}</a>
                                            </h6>
