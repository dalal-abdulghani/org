                ...
                <div class="col-12">
                    ...
                    <div class="post post-single">
                        ...
                        <div class="featured-image">
                            <img src="{{ asset( $news->cover_image) }}" alt="post-title" width="100%" height="300" />
                        </div>
                        <!-- post content -->
                        <div class="post-content clearfix">
                              <p class="news-content" style=" text-align: justify;" >{{ $news->content }}</p>
                        </div>
                                ...
                                <div class="col-md-6 col-12">
                                    ...
                                    <ul class="social-icons list-unstyled list-inline mb-0 float-md-end" style="margin-left: 10px">
                                        ...
                                        <li class="list-inline-item">
                                            ...
                                            <span id="likes-count">{{ $news->likes_count }}</span> إعجابات
                                        </li>
