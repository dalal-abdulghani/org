...
@section('title', $settings['site_name'] . ' - الأخبار')
                            ...
                            <div class="post post-grid rounded bordered">
                                <div class="thumb top-rounded">
                                    ...
                                    <a href="blog-single.html">
                                        <div class="inner">
                                            <img src="{{ asset( $item->cover_image) }}" alt="post-title" width="100px" height="100px"/>
                                        </div>
                                    </a>
                                </div>
                                <div class="details">
                                    ...
                                    <h5 class="post-title mb-3 mt-3"><a href="{{ route('news.details',  $item->id) }}">{{ Str::limit($item->title, 20) }}</a></h5>
                    ...
                    <nav>
                        @if ($news->total() > 6)
                            <ul class="pagination justify-content-center custom-pagination">
                                ...
                                @foreach ($news->links() as $page => $url)
					...
					<div class="sidebar">
						...
						<div class="widget rounded">
							<div class="widget-about data-bg-image text-center">
								...
								<p class="mb-4">
                                    {{ $settings['site_description'] ?? '             مؤسسة الرواسخ التنموية هي منظمة غير ربحية تسعى إلى تحقيق التنمية المستدامة في مختلف المجتمعات من خلال تنفيذ المشاريع والبرامج التي تعزز التعليم، تمكين الشباب، ودعم الفئات الأكثر احتياجًا. تسعى المؤسسة إلى تقديم حلول مبتكرة تهدف إلى تحسين جودة الحياة وتحقيق التقدم الاجتماعي والاقتصادي.
' }}
                                </p>
						...
						<div class="widget rounded">
							<div class="widget-header text-center">
								<h3 class="widget-title">هاشتاج </h3>
							</div>
							<div class="widget-content">
								<a href="#" class="tag">#تبرع</a>
								<a href="#" class="tag">#ايتام</a>
								<a href="#" class="tag">#كفالة</a>
								<a href="#" class="tag">#مشاريع</a>
								<a href="#" class="tag">#عمل خيري</a>
							</div>
						</div>
