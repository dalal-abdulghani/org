...
<head>
    ...
    <title>
        @yield('title', (isset($settings['site_name']) ? $settings['site_name'] : 'مؤسسة رواسخ التنموية') . ' - الرئيسية')
    </title>
...
<body>
    <header class="fixed-top" style="z-index: 9999; ">
        ...
        <div class="navbar-expand-md navbar-light bg-white p-0">
            <div class="fluid-container">
                ...
                ">
                            <img class="logo" loading="lazy" src="{{ asset('images/٢٠٢٤١٠٢٢_١١٥٧٢٤.jpg') }}" alt="" width="50" />
                        </a>

                        <div class="d-block d-md-none d-flex align-items-center me-3" style="height: max-content; margin: 13px">
                            <a class="nav-link p-0 pe-3 d-flex align-items-center" href="{{ route('login') }}">
                                <i class="fa-solid fa-circle-user" style="font-size: 20px; color: #263676"></i>
                            </a>

                            <a class="nav-link p-0 ps-3 d-flex align-items-center" href="{{ route('contact.index') }}" id="search">
                                <i class="fa-solid fa-phone-flip" style="color: #263676; font-size: 20px"></i>
                            </a>
                        </div>
                        ...
                        <div class="collapse navbar-collapse" id="navbarScroll">
                            ...
                            <a class="btn btn-gradient d-none d-md-block" href="{{ route('donate') }}" style="
    ...
    <a href="#" id="backToTop" class="back-to-top">
        <i class="fas fa-arrow-up" style="color: #ffff"></i>
    </a>
