    <!-- Sidebar -->
    <ul class="pr-0 navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color: #93b85f">

      <!-- Sidebar - Brand -->
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/">
        <div class="sidebar-brand-icon">
          <img style="width:70%" src="{{ asset('images/new-removebg-preview.png') }}">
        </div>
      </a>
